...
See the [installation part](https://github.com/DarioNonis/Skeleton#install) of my **[Skeleton project template](https://github.com/DarioNonis/Skeleton)**.

<br/>

# Releases

If you just want to test the program without editing the source code, go see the **[Releases](https://github.com/DarioNonis/Magic-Royale/releases)**.
